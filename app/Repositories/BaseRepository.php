...
abstract class BaseRepository
{
    ...
    public function simplePaginate(array $columns = ['*'], int $perPage = ITEM_PER_PAGE, string $paginationKey = 'p')
    {
        return $this->model->simplePaginate($perPage, $columns, $paginationKey);
    }

    public function paginateWithFilters($searchFields, $orderFields = null, $whereArray = null, $selectData = null, $joinArray = null, $paginationKey = 'p', $dateField = 'created_at')
    {
